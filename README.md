...
* [Google reCAPTCHA](https://developers.google.com/recaptcha/docs/invisible) is integrated in this app. Please create a new file as `static_data/recaptcha.json` with following content: 
  ```json
